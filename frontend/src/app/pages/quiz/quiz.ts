...
export class Quiz implements OnInit {
  ...
  constructor(
    ...
    private groupService: DictionaryGroupService, private wordPairService: WordPairService, private cdr: ChangeDetectorRef) {}
  ...
  startQuiz() {
    ...
    this.questions = words.map(
      word => this.createQuestion(word)
    );
  ...
  nextQuestion() {
    ...
    if (
      !this.answerCorrect &&
      this.settings?.mode === 'UNTIL_CORRECT'
    ) {
